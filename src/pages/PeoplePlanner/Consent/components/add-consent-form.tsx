...
// Mock consent form templates
const consentFormTemplates = [
  { id: 'covid-19', name: 'COVID-19 Testing', selected: false },
  {
    id: 'care-treatment',
    name: 'Consent to Care & Treatment',
    selected: false
  },
  { id: 'financial', name: 'Financial Consent', selected: false },
  { id: 'media', name: 'Media Consent', selected: false },
  { id: 'medication', name: 'Medication Consent', selected: false },
  { id: 'vaccination', name: 'Vaccination Consent', selected: false }
];

export default function AddConsentFormPage() {
  ...
  return (
    <div className="min-h-screen ">
      <div className="flex flex-col gap-4">
        {/* Left Sidebar */}
        <div>
          <Button className="bg-supperagent text-white hover:bg-supperagent/90" onClick={()=> navigate(-1)}>
        ...
        <div>
          <div className="flex flex-row items-start gap-4">
            <div className="w-80 space-y-6 bg-gray-50">
              <div className="rounded-lg bg-white p-4 shadow-lg">
                <h2 className="mb-2 font-semibold">Select Consent Forms</h2>
                <p className="mb-4 cursor-pointer text-sm text-supperagent hover:underline">
                  Click here to view consent forms
                </p>
                  ...
                  <CardContent className="p-6">
                    {selectedForm ? (
                      ...
                      <div className="py-12 text-center text-muted-foreground">
                        <p>
                          Select a consent form from the left sidebar to begin
                        </p>
                      </div>
                    )}
                  </CardContent>
