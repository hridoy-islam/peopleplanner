...
const EditEmployee = () => {
  ...
  const {
    ...
    isFieldSaving,
    validationErrors // Get validation errors from hook
  } = useEditEmployee();
  ...
  // Helper to safely get missing fields for a specific tab
  const getMissingFields = (tabId: string) =>
    validationErrors[tabId]?.missingFields || [];
  ...
  const tabs = [
    {
      ...
      component: (
        <PersonalInfoTab
          ...
          missingFields={getMissingFields('personal')}
        />
      )
    },
    {
    ...
    },
    {
      ...
      component: (
        <EmploymentDetailsTab
          ...
          isFieldSaving={isFieldSaving}
          missingFields={getMissingFields('employment')}
        />
      )
    },
    {
      ...
      component: (
        <IdentificationTab
          ...
          onUpdate={handleFieldUpdate}
          isFieldSaving={isFieldSaving}
          missingFields={getMissingFields('settings')}
        />
      )
    },
    {
    ...
    },
    {
      ...
      component: (
        <DisabilityInfoTab
          ...
          onCheckboxChange={handleCheckboxChange}
          isFieldSaving={isFieldSaving}
          missingFields={getMissingFields('disability')}
        />
      )
    },
    {
      ...
      component: (
        <BeneficiaryTab
          ...
          onCheckboxChange={handleCheckboxChange}
          isFieldSaving={isFieldSaving}
          missingFields={getMissingFields('beneficiary')}
        />
      )
    },
  ...
  // Map IDs to Labels for the notification component
  const tabLabels = tabs.reduce(
